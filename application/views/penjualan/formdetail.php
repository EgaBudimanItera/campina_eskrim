							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										...
										<p>Invoice Penjualan <span class="bread-ntd">
									</div>
								</div>
							</div>
                        	...
                        	<div class="row">
                        		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="invoice-cmp-ds ivc-frm">
                                        ...
                                        <div class="comp-tl">
                                            <h2><?=$penjualan->namatoko?></h2>
                                            <p><?=$penjualan->alamattoko?></p>
                                        </div>
                                        <div class="cmp-ph-em">
                                            <span><?=$penjualan->notelptoko?></span>
                                			...
                                			<thead>
											  ...
											  <tbody>
											    <?php
											      $no=1;
											      $total=0;
											      foreach($detpenjualan as $l){
											        $sub=$l->jumlahjual*$l->hargajual;
											    ?>
											    <tr>
											      <td><?=$no++;?></td>
											      <td><?=$l->namabarang;?></td>
											      <td ><?=number_format($l->jumlahjual);?></td>
											      <td  align="Right"><?=number_format($l->hargajual);?></td>
											      <td align="Right"><?php echo number_format($sub)?></td>
											    </tr>
											    
											    <?php
											      $total=$total+($l->jumlahjual*$l->hargajual);
											      }
											    ?>
											    <tr>
											      <td colspan="4" align="Left">Total penjualan</td>
