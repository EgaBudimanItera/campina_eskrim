							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Data Pencarian Stok Es Krim</h2>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-example-wrap mg-t-30">
                        ...
                        <form action="<?=base_url()?>laporanstok/prosescari" target="_blank" role="form" method="post">
	                        ...
	                        <div class="form-example-int form-horizental mg-t-15">
	                            <div class="form-group">
	                                <div class="row">
	                                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
	                                        <label class="hrzn-fm">Barang</label>
	                                    </div>
	                                    <div class="col-lg-4 col-md-3 col-sm-3 col-xs-12">
	                                        <div class="nk-int-st">
	                                           	<div class="chosen-select-act fm-cmp-mg">
				                                    <select class="chosen" name="kodebarang" data-placeholder="Pilih Barang">
														<option value=""></option>
